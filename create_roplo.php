...
<main>
	...
	<form method="post" action="create_roplo_update.php">
		...
		<input type="text" name="admin_id" value="<?php echo $member['mb_id']?>" hidden ><br>
		<label for='id'> 주소 : </label> <?php echo $server_url.'/' ?><input type="text" name="id" <?php echo $w=='u'?'hidden':'' ?> <?php echo $w=='u'?"value='{$roplo['id']}'":"" ?>> <br>
