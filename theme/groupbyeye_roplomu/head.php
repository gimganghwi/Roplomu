...
<div id="hd">
    ...
    <div id="gnb_all">
                <h2>전체메뉴</h2>
                <ul class="gnb_al_ul">
                    <li style="float:left;"><button type="button" class="gnb_close_btn"><i class="fa fa-times" aria-hidden="true"></i></button></li>
                    <?php
    ...
    $(function(){
        function removeStyle(){ $(this).attr('style','') }
        $(".gnb_menu_btn").click(function(){
            $("#gnb_all").slideDown(100);
            $("#gnb").slideUp(100);
        });
        $(".gnb_close_btn").click(function(){
            $("#gnb_all").slideUp(100, removeStyle);
            $("#gnb").slideDown(100, removeStyle);
        });
    });
